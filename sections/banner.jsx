      ...
      <div className="container">
        ...
        <div className="row mt-4">
          <div
            ...
            data-aos-delay="200"
          >
            <a className="btn btn-secondary btn-preview" href="#" role="button">
              Preview
            </a>
          </div>
          <div
            ...
            data-aos-delay="200"
          >
            <a className="btn btn-secondary btn-detail" href="#" role="button">
              Product Details
            </a>
          </div>
          <div
            ...
            data-aos-delay="200"
          >
            <a className="btn btn-secondary btn-message" href="#" role="button">
